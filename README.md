...
| `QuestManager.cs` | 퀘스트 완료 타이밍 통일, `_completedQuest` 보관, `HasCompletedQuest` 폴링, 미수령 시 `StartQuest` 차단 | [보기 📄](https://github.com/akfvhd1321/KK.BlackSmith/blob/develop/Assets/CWT/CWT_Scripts/Manager/QuestManager.cs) |
| `SoundManager.cs` | BGM/SFX 재생·볼륨 중앙 관리 | [보기 📄](https://github.com/akfvhd1321/KK.BlackSmith/blob/develop/Assets/CWT/CWT_Scripts/Manager/SoundManager.cs) |
---
